...
VS_OUTPUT Alpha_Co_Nr_SpVS( float4 inPos   : POSITION, 
...
void Alpha_Co_Nr_SpPS( in  float2 vTex : TEXCOORD0,
...
technique Alpha_Co_Nr_Sp
{
   pass P0
   {
      ...
      VertexShader = compile vs_2_0 Alpha_Co_Nr_SpVS();
      PixelShader = compile ps_2_0 Alpha_Co_Nr_SpPS();      
   }
}