...
VS_OUTPUT Alpha_Both_Color_NormalVS( float4 inPos   : POSITION, 
...
void Alpha_Both_Color_NormalPS( in  float2 vTex : TEXCOORD0,
...
technique Alpha_Both_Color_Normal
{
   pass P0
   {
      ...
      cullmode = none;
      VertexShader = compile vs_2_0 Alpha_Both_Color_NormalVS();
      PixelShader = compile ps_2_0 Alpha_Both_Color_NormalPS();      
   }
}