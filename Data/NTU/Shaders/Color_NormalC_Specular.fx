...
VS_OUTPUT Color_NormalC_SpecularVS( float4 inPos   : POSITION, 
...
void Color_NormalC_SpecularPS( in  float2 vTex : TEXCOORD0,
                   ...
                   out float4 oCol : COLOR0    )
{
   ...
   oCol.rgb = colorT.rgb*(ambLgt*amb + diff*mainLightColor*dif) + spec*mainLightColor*speT*spe;
  
   oCol.a = dif.a;
}


technique Color_NormalC_Specular
{
   pass P0
   {
      VertexShader = compile vs_2_0 Color_NormalC_SpecularVS();
      PixelShader = compile ps_2_0 Color_NormalC_SpecularPS();      
   }
}