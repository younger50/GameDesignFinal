...
VS_OUTPUT Alpha_Both_ColorVS( float4 inPos : POSITION, 
...
void Alpha_Both_ColorPS( in  float2 vTex : TEXCOORD0,
...
technique Alpha_Both_Color
{
   pass P0
   {
      ...
      cullmode = none;
      VertexShader = compile vs_2_0 Alpha_Both_ColorVS();
      PixelShader = compile ps_2_0 Alpha_Both_ColorPS();      
   }
}